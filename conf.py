...
_C.CMF.USE_WEIGHTING = True
_C.CMF.USE_PRIOR_CORRECTION = True
_C.CMF.USE_CONSISTENCY = True
_C.CMF.MOMENTUM_PROBS = 0.9   
_C.CMF.TEMPERATURE = 1/3
...
def get_num_classes(dataset_name):
    dataset_name2num_classes = {"imagenet": 1000, "imagenet_c": 1000, "imagenet_k": 1000, "imagenet_r": 200,
